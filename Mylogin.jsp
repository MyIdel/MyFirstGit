		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<font>会员登录</font>
					<div>&nbsp;</div>
					<form class="form-horizontal" action="<%=path%>/userServlet" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<img src="<%=path%>/checkimage" onclick="changeImage(this)" />
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									<label> <input type="checkbox" id="autoLogin" name="autoLogin" value="true"> 自动登录
									</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label> <input
										type="checkbox">记住用户名
									</label>
								</div>
